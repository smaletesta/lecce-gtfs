...
L.Icon.Label.Default = L.Icon.Label.extend({
	...
	var cloudmadeAttribution = '<a href="http://www.ulmapi.de">UlmApi.de</a>, Map data &copy; 2011 OpenStreetMap contributors, Imagery &copy; MapQuest, Created by @cortesefed from Bus Timetables by <a href="http://dati.comune.lecce.it/dataset?q=sgm&sort=score+desc%2C+metadata_modified+desc" />SGM Lecce</a>, Lic. CC-By OpenData Lecce';
...
var markerIcon = bIcon;
		...
		if(trips && trips[trip]){
						popup = "<b>Linea: "+trips[trip].route_short_name+"</b><br>"+trips[trip].route_long_name;
						//bus or tram?
